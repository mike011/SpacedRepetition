#
#  Be sure to run `pod spec lint SpacedRepetition.podspec' to ensure this is a
...
#s.license      = "MIT (example)"
  s.license    = { :type => 'Apache-2.0', :file => './LICENSE_TOO_ILL' }
...
#  s.platform     = :ios, "11.0"
  ...
  s.source       = { :git => "http://https://github.com/mike011/SpacedRepetition.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Sources/SpacedRepetition/**/*"
